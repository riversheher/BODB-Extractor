...
class MarketDataQueries:
    ...
    def get_records_by_ticker(self, ticker: str) -> dict    :
    ...
    def get_records_by_timestamp_range(self, start_time: datetime, end_time: datetime) -> dict:
    ...
    def get_records_by_strike_price(self, strike: str) -> dict:
    ...
    def get_records_by_underlying_price(self, underlying_price: float) -> dict:
    ...
    def get_records_by_bid(self, bid: float) -> dict:
    ...
    def get_records_by_ask(self, ask: float) -> dict:
...
class TradeRecordQueries:
    ...
    def get_records_by_option_type(self, option_type: str) -> dict:
    ...
    def get_records_by_price(self, price: float) -> dict:
    ...
    def get_records_by_volume(self, volume: int) -> dict:
